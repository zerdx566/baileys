...
const extractFromButtonsMessage = (msg) => {Add commentMore actions
...
} else if (header ? msg.header?.videoMessage : msg.videoMessage) {Add commentMore actions
return { videoMessage: header ? msg.header.videoMessage: msg.videoMessage }
} else if (header ? msg.header?.locationMessage : msg.locationMessage) {Add commentMore actions
return { locationMessage: header ? msg.header.locationMessage : msg.locationMessage }
} else if (header ? msg.header?.productMessage : msg.productMessage) {Add commentMore actions
...
content = normalizeMessageContent(content)
if (content?.buttonsMessage) {Add commentMore actions
return extractFromButtonsMessage(content.buttonsMessage)
}
if (content?.interactiveMessage) {Add commentMore actions
return extractFromButtonsMessage(content.interactiveMessage)
}
if (content?.templateMessage?.interactiveMessageTemplate) {Add commentMore actions
return extractFromButtonsMessage(content?.templateMessage?.interactiveMessageTemplate)
}
if (content?.templateMessage?.hydratedFourRowTemplate) {Add commentMore actions
return extractFromButtonsMessage(content?.templateMessage?.hydratedFourRowTemplate)
if (content?.templateMessage?.hydratedTemplate) {Add commentMore actions
return extractFromButtonsMessage(content?.templateMessage?.hydratedTemplate)
}
if (content?.templateMessage?.fourRowTemplate) {Add commentMore actions
